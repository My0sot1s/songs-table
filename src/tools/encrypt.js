    ...
    var d = {},
      ...
      q = (l.BufferedBlockAlgorithm = t.extend({
        ...
        kY3x: function (a) {
          ...
          j = u.min(4 * a, j)
          if (a) {
            for (var q = 0; q < a; q += k) this.qL5Q(e, q)
            q = e.splice(0, a)
            c.sigBytes -= j
          }
    ...
    d.BlockCipher = v.extend({
      ...
      reset: function () {
        ...
        var a = this.cfg,
          b = a.iv,
          a = a.mode
        if (this.Qq2x == this.JY1x) var c = a.createEncryptor
        else (c = a.createDecryptor), (this.JP1x = 1)
